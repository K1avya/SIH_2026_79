  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen">
        {/* Desktop Sidebar */}
        <aside
          className="hidden w-64 flex-col border-r backdrop-blur-xl lg:flex"
          style={{
        ...
        >
          ...
          {/* User Status Bar */}
          <div className="border-b p-4" style={{ borderColor: 'var(--q-line)' }}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="flex h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
                <span className="text-xs font-medium text-[var(--q-muted)]">Level:</span>
                <span
            ...
            <div className="mt-3">
              <div className="mb-1 flex items-center justify-between text-[11px] text-[var(--q-muted)]">
                <span>Course Progress</span>
                <span className="font-semibold text-[var(--q-text)]">{user.overallProgress}%</span>
              </div>
              ...
              return (
                <Link
                  ...
                  className={`group flex items-center justify-between rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all ${
                    isActive
                      ...
                      : 'text-[var(--q-muted)] hover:text-white hover:bg-white/5'
                  }`}
                  style={
                    isActive
                      ? {
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className={isActive ? 'text-black' : 'text-[var(--q-cyan)] group-hover:text-white'}>
                      {item.icon}
                    </span>
